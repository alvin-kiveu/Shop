 ...
 * @subpackage AlvinKiveu [ UMESKIA SOFTWARES ]
    ...
    if (class_exists('WC_Payment_Gateway')) {
        ...
        class WC_MPESA_Gateway extends WC_Payment_Gateway
        {
            ...
            public function __construct()
            {
                ...
                add_filter('woocommerce_should_load_payment_gateway', [$this, 'enable_for_blocks'], 10, 2);
             ...
             * @return bool
             */
            public function enable_for_blocks($should_load, $gateway_id)
            {
                if ($gateway_id === 'mpesa') {
                    return true; // Enable support for WooCommerce Blocks
                }
                return $should_load;
            }
                                    ...
                                    <tr class="woocommerce-table__line-item order_item">
                                        <td class="woocommerce-table__product-name product-name">
                                            <ol>
                                                ...
                                                ' . (($mpesa->type === 4) ? "<li>Enter <b>{$mpesa->shortcode}</b> as business no.</li><li>Enter <b>{$order_id}</b> as Account no.</li>" : "<li>Enter <b>{$mpesa->headoffice}</b> as till no.</li>") . '

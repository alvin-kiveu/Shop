=== Umeskia MPesa Plugin===
Contributors: alvin
Donate link: https://umeskiasoftwares.com/
Tags: The Umeskia-Mpesa-Plugin is a software tool that integrates M-Pesa mobile money payments into websites and applications.
...
1. Upload `osen-wc-mpesa` to the `/wp-content/plugins/` directory.
